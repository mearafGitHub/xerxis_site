...
const CARDS = [
  { title: "Tank1", detail: "ETH", value: 4.26, variable: 4.2, pic: Tank1 },
  { title: "WarDrone", detail: "ETH", value: 4.26, variable: 4.2, pic: WarDrone },
  { title: "SecretWeapon", detail: "ETH", value: 4.49, variable: 4.46, pic: SecretWeapon},
  { title: "WariorJets", detail: "ETH", value: 4.26, variable: 4.2, pic: WariorJets },
  { title: "SecretWeapon", detail: "ETH", value: 4.49, variable: 4.46, pic: SecretWeapon},
  { title: "Sword1", detail: "ETH", value: 4.26, variable: 4.2, pic: Sword1 },
  { title: "TankDesert", detail: "ETH", value: 4.49, variable: 4.46, pic: TankDesert},
  { title: "WarJets2", detail: "ETH", value: 4.26, variable: 4.2, pic: WarJets2 },
  { title: "WarJets", detail: "ETH", value: 4.26, variable: 4.2, pic: WarJets },
  { title: "WeaponOne", detail: "ETH", value: 4.49, variable: 4.46, pic: WeaponOne},
  { title: "SnipperGun3", detail: "ETH", value: 4.26, variable: 4.2, pic: SnipperGun3 },
  { title: "Dagger1", detail: "ETH", value: 4.26, variable: 4.2, pic: Dagger1 },
  { title: "SnipperGun", detail: "ETH", value: 4.49, variable: 4.46, pic: SnipperGun},
  { title: "FancyGun", detail: "ETH", value: 4.26, variable: 4.2, pic: FanckyGun },
  { title: "SnipperGun2", detail: "ETH", value: 4.49, variable: 4.46, pic: SnipperGun2},
  { title: "NightGun", detail: "ETH", value: 4.26, variable: 4.2, pic: NightGun },
  { title: "Dagger3", detail: "ETH", value: 4.49, variable: 4.46, pic: Dagger3},
  { title: "Dagger2Big", detail: "ETH", value: 4.26, variable: 4.2, pic: Dagger2Big },
];
